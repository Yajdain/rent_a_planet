...
mars = PlanetOffer.new(name: "Mars", title: "La planète rouge", price: 5.6, gravite: 3.721, superficie: 144.8, rayon: 3_389.5, location: "227,9 millions km away from sun")
...
venus = PlanetOffer.new(name: "Venus", title: "La planète de l'amour", price: 10.2,  gravite: 8.87, superficie: 460.2, rayon: 6_051.8, location: "108 millions km away from sun")
...
saturne = PlanetOffer.new(name: "Saturne", title: "Les sept anneaux", price: 5.9, gravite: 10.44, superficie: 42.7, rayon: 58_232, location: "5 millions km away from sun")
...
pluton = PlanetOffer.new(name: "Pluton", title: "La planète des morts", price: 12.8, gravite: 10.44, superficie: 6_650_000, rayon: 1_188.3, location: "5,913 millions away km from sun")
...
neptune = PlanetOffer.new(name: "Neptune", title: "La planète de la mer", price: 7.2, gravite: 3.721, superficie: 144.8, rayon: 3_389.5, location: "227,9 millions away km from sun")
...
mercure = PlanetOffer.new(name: "Mercure", title: "La planète de l'intelligence", price: 10.3, gravite: 3.7, superficie: 74.8, rayon: 2_439.7, location: "58 millions km away from sun")
